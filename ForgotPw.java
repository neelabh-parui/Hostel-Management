...
public class ForgotPw extends HttpServlet {
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Hostel","root","15c4131");
           ...
           ResultSet rs=stmt.executeQuery("select UserID, SecQues, SecAns from Admin");
           int uid;
           String Q;
           int flag=0;
           while(rs.next())
           {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Security Question</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<center>");
            out.println("<h1>Security Question</h1>");
            out.println("<hr>");
            out.println("<hr>");
           
            out.println("<form action=\"ChangePw\" >");
...
}catch(Exception e)
    {
         response.sendRedirect("DataError.jsp");
           ...
           /* out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ForgotPw</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ForgotPw at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
